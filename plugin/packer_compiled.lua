...
_G.packer_plugins = {
  ...
  ["github-nvim-theme"] = {
    loaded = true,
    path = "/Users/jordi.nebot/.local/share/nvim/site/pack/packer/start/github-nvim-theme",
  ...
  neoformat = {
    loaded = true,
    path = "/Users/jordi.nebot/.local/share/nvim/site/pack/packer/start/neoformat",
  ...
  ["vim-repeat"] = {
    loaded = true,
    path = "/Users/jordi.nebot/.local/share/nvim/site/pack/packer/start/vim-repeat",
